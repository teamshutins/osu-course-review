...
import 'package:osu_course_review/screens/search_page.dart';
          ...
          children: [
            ...
            Align(
              ...
              child: Container(
                ...
                child: Text('CS 161 Introduction to Computer Science I',
                    style: TextStyle(
                      color: Colors.black,
            ...
            Align(
              ...
              child: Container(
                ...
                child: Text('Section: 400 [Use JSON file]',
            ...
            Align(
              ...
              child: Container(
                // Taka: We will replace the string later.
                child: Text(
                    'Description: [Replaced by the Course Info read from JSON file]',
                    style: TextStyle(color: Colors.black, fontSize: 24)),
              ),
            ),
            ...
            Align(
              ...
              child: Container(
                // Taka: We will replace the string later.
                child: Text('Instructor: Tim Alcon [Use JSON file]',
                    style: TextStyle(color: Colors.black, fontSize: 24)),
              ),
            ),
